...
import { AddContextPackPage } from '../support/add-cp.po';
...
describe('Add Context Pack', () => {
   ...
   describe('Adding a new context pack', () => {
    ...
    it('Should go to the right page, and have the right info', () => {
        const testList: Array<WordList> = []; //replace with a real word list later
        ...
        cy.get('.cp-card-name').should('have.text', contextPack.name);
